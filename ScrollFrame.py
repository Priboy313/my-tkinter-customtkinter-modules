...
if __name__ == "__main__":
	...
	for row in range(100):
		tk.Label(scrollFrame.viewPort, text=str(row), width=3).grid(row=row, column=0)
		tk.Button(scrollFrame.viewPort, text=f"second column of row {row}").grid(row=row, column=1)
	root.mainloop()